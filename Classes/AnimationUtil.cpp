...
Animate* AnimationUtil::createWithSingleFrameName_monster1()
{
    ...
    monster1_animation->setDelayPerUnit(0.5);
...
Animate* AnimationUtil::createWithSingleFrameName_monsterGhost()
{
    Vector<SpriteFrame*> monster_Ghost;
    Sprite* monsterGhost11 = Sprite::create("monster2.png");
    SpriteFrame* monsterGhost1 = SpriteFrame::create("monster2.png", Rect(0, 0, monsterGhost11->getContentSize().width, monsterGhost11->getContentSize().height));
    monster_Ghost.pushBack(monsterGhost1);
    Sprite* monsterGhost12 = Sprite::create("monster22.png");
    SpriteFrame* monsterGhost2 = SpriteFrame::create("monster22.png", Rect(0, 0, monsterGhost12->getContentSize().width, monsterGhost12->getContentSize().height));
    monster_Ghost.pushBack(monsterGhost2);
    Animation* monster4_animation = Animation::createWithSpriteFrames(monster_Ghost);
    monster4_animation->setLoops(-1);
    monster4_animation->setDelayPerUnit(0.5);
    auto monster4_animate = Animate::create(monster4_animation);

    return monster4_animate;
}
